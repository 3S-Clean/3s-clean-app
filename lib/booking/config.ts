...
export const EXTRAS = [
    { id: "oven", name: "Oven deep clean", price: 100, hours: 2, icon: "flame", unit: "unit" },
    { id: "fridge", name: "Fridge deep clean", price: 50, hours: 1, icon: "refrigerator", unit: "unit" },
    { id: "windows", name: "Window cleaning", price: 4.25, hours: 0.08, icon: "app-window", unit: "m²" },
    { id: "balcony", name: "Balcony cleaning", price: 52.5, hours: 1, icon: "trees", unit: "10 m²" },
];
