...
export type ServiceIncludeKey =
    ...
    | "livingAreas"
    | "trash"
    | "finishingTouches"; // подставь свои реальные фичи
...
export type ServiceConfig = {
    ...
    // ✅ i18n keys
    titleKey: string; // e.g. "services.maintenance.title"
    descKey: string;  // e.g. "services.maintenance.desc"

    baseFeaturesKey?: string; // e.g. "services.common.includesLabel" (если надо)
    includesKeys: ServiceIncludeKey[]; // ✅ только ключи
};
/* =========================
   APARTMENT / PEOPLE
========================= */
