...
export default function LoginPage() {
    ...
    const onSubmit = async (values: LoginValues) => {
        ...
        // имитация запроса (потом заменим на Supabase)
  ...
  "
                    >
                        <Logo className="h-14 w-14 text-black/80" />
                    </a>
                </div>
                ...
                <div className={[
                    ...
                    >
                        ...
                        <button
                            ...
                            className="w-full rounded-2xl bg-black py-3.5 text-[15px] font-medium text-white transition
