...
export default function HomePageClient() {
    ...
    useEffect(() => {
        const timer = setTimeout(() => setIsLoaded(true), 380);
    ...
    return (
        <>
            ...
            supports-[height:100dvh]:min-h-[calc(100dvh-80px)]
            pb-28 sm:pb-32
          ...
          "
                    ...
                    <div className="xl:hidden">
                        {heroRaw.split("\n").map((line, i) => (
                            <div
                                key={`m-${i}`}
                                className={`
                  transition-all duration-[1900ms] ease-[cubic-bezier(0.16,1,0.3,1)]
                ...
                `}
                    ...
                    max-w-[14ch]
                    text-[90px] sm:text-[98px] md:text-[106px] lg:text-[108px]
                    leading-[1.03] sm:leading-[1.04] md:leading-[1.05]
                  "
                                >
                                    {line}
                                </h1>
              ...
              `}
                    ...
                    transition-all duration-[1600ms] ease-[cubic-bezier(0.16,1,0.3,1)]
                    ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-14"}
                  `}
                                    style={{ transitionDelay: `${1900 + index * 280}ms` }}
                                >
                                    <div
                                        className={`
                      ${cardBase}
                ...
                <section className="w-full">
                    ...
                    <div className="relative w-full h-[100svh] supports-[height:100dvh]:h-[100dvh] overflow-hidden">
                        <video
                            autoPlay
                            muted
                            loop
                ...
                {/* EXPERIENCE (kicker + title всегда) */}
